        ...
        <div className='outercontainer' style={{backgroundImage: `url(${bg})`, backgroundRepeat: "no-repeat", backgroundSize: "cover"}}> 
            ...
            <div className='middlerow'>
                <div className='container'>
                    ...
                    <h3>GeneAI is the only dating app that incorporates image generation technology. Utilize novel image processing techniques to find your matches today!</h3>
           ...
           <div className='bottomrow'>
             ...
             <div className='container'>
               ...
               <h3>Each match allows users to obtain high quality, one-of-a-kind imgs of your children. </h3>
               <div className='buttonContainer'>
                 <button>
                    Get It Now
                 </button>
